...
export const translations = {
    ...
    nav: {
        ...
        startProject: { nl: "Start Jouw Project", en: "Start a Project", fr: "Démarrer un Projet" },
    },
    ...
    hero: {
        ...
        trusted: { nl: "Vertrouwd door 50+ bedrijven", en: "Trusted by 50+ businesses", fr: "Approuvé par 50+ entreprises" },
    },
    ...
    servicesPreview: {
        ...
        subtitle: {
            ...
            fr: "Services ciblés conçus pour vous apporter des résultats. Ni plus, ni moins.",
        },
        webDesign: {
            ...
            description: {
                ...
                fr: "Sites web personnalisés pour vitesse, conversions et croissance. Pas de templates, pas de compromis.",
            },
        },
        mobile: {
            ...
            description: {
                ...
                fr: "Expériences responsive superbes et performantes sur tous les appareils.",
            },
        },
        brand: {
            ...
            description: {
                ...
                fr: "Systèmes d'identité visuelle qui rendent votre entreprise reconnaissable.",
            },
        },
        performance: {
            ...
            description: {
                ...
                fr: "Temps de chargement ultra-rapides qui maintiennent l'engagement et améliorent le SEO.",
            },
        },
    },
    ...
    // Process Section
    process: {
        title: { nl: "Eenvoudig proces, uitzonderlijke resultaten", en: "Simple process, exceptional results", fr: "Processus simple, résultats exceptionnels" },
        subtitle: {
            ...
            fr: "Une approche rationalisée qui vous tient informé et livre à temps.",
        },
        discover: {
            title: { nl: "Ontdek", en: "Discover", fr: "Découvrir" },
            description: {
                ...
                fr: "Nous apprenons votre entreprise, objectifs et audience pour créer une base stratégique.",
            },
        },
        design: {
    ...
    // CTA Section
    cta: {
        title: { nl: "Klaar om online op te vallen?", en: "Ready to stand out online?", fr: "Prêt à vous démarquer en ligne ?" },
        subtitle: {
            ...
            fr: "Créons quelque chose qui fait vraiment grandir votre entreprise. Aucun engagement — juste une conversation sur vos objectifs.",
        },
    ...
    // Why Page
    why: {
        title: { nl: "Waarom Dit Werkt", en: "Why This Works", fr: "Pourquoi Ça Marche" },
        subtitle: {
            ...
            fr: "Nous comprenons les problèmes auxquels les entreprises locales font face en ligne — parce que nous les avons résolus des dizaines de fois.",
        },
        ...
        problems: {
            ...
            fr: [
                "Votre site web semble dépassé et ne représente pas la qualité de votre entreprise",
                "Vous perdez des clients potentiels au profit de concurrents avec une meilleure présence en ligne",
                "Votre site ne fonctionne pas bien sur les téléphones (60%+ du trafic)",
                "Vous n'avez aucune idée si votre site web génère réellement des leads",
        ...
        solutions: {
            ...
            fr: [
                "Design moderne et professionnel qui construit instantanément la confiance",
                "Mises en page axées sur la conversion qui transforment les visiteurs en leads",
                ...
                "Prix fixes, délais clairs et communication honnête",
            ],
        },
        stats: {
        ...
        approach: {
            ...
            resultsTitle: { nl: "Resultaten Boven Esthetiek", en: "Results Over Aesthetics", fr: "Résultats Avant l'Esthétique" },
            resultsDesc: {
                ...
                fr: "Un beau site qui ne génère pas de leads est juste de l'art coûteux. Nous concevons avec la conversion à l'esprit — chaque élément a un but. Propositions de valeur claires, CTA stratégiques et expériences utilisateur sans friction.",
            },
            ...
            speedDesc: {
                ...
                fr: "Nous ne traînons pas les projets pendant des mois. Notre processus rationalisé livre votre site en 2-4 semaines, pas 2-4 mois. Nous respectons votre temps car chaque jour sans site approprié est un jour d'opportunités manquées.",
            },
            ...
            surprisesDesc: {
                ...
                fr: "Tarification fixe signifie que vous savez exactement ce que vous payez avant de commencer. Pas de tarifs horaires qui explosent, pas de coûts 'inattendus'. Nous évaluons soigneusement, tarifons équitablement et livrons ce que nous promettons.",
            },
            ...
            lastingDesc: {
                ...
                fr: "Nous n'utilisons pas de page builders ou de templates gonflés. Du code propre et moderne signifie que votre site charge rapidement, se classe mieux et ne s'effondre pas quand vous devez faire des changements. De plus, vous en êtes vraiment propriétaire — pas de verrouillage vendeur.",
            },
        },
    ...
    // About Page
    about: {
        title: { nl: "Over Ons", en: "About Us", fr: "À Propos" },
        subtitle: {
            ...
            fr: "Un petit studio digital belge obsédé par la création de sites web qui fonctionnent vraiment pour votre entreprise.",
        },
        ...
        storyP1: {
            ...
            fr: "Nova Studio est né d'une simple observation : trop d'entreprises locales ont des sites qui travaillent contre elles, pas pour elles. Designs dépassés, temps de chargement lents et zéro focus sur la conversion leur coûtent des clients chaque jour.",
        },
        storyP2: {
            ...
            fr: "Nous avons créé ce studio pour changer cela. Notre mission est de donner aux entreprises belges — freelancers, magasins locaux, services professionnels — la même qualité de présence web dont jouissent les grandes entreprises, mais à un prix et un rythme qui ont du sens.",
        },
        storyP3: {
            ...
            fr: "Chaque site web que nous construisons est conçu avec un objectif : aider votre entreprise à se développer. Un beau design est important, mais il est inutile s'il ne convertit pas les visiteurs en clients.",
        },
        basedIn: { nl: "Gevestigd in België", en: "Based in Belgium", fr: "Basé en Belgique" },
        valuesTitle: { nl: "Waar We Voor Staan", en: "What We Stand For", fr: "Ce Que Nous Défendons" },
        ...
        values: {
            quality: {
                title: { nl: "Kwaliteit Boven Kwantiteit", en: "Quality Over Quantity", fr: "Qualité Avant Quantité" },
                description: {
                    ...
                    fr: "Nous prenons moins de projets pour donner à chacun l'attention qu'il mérite. Pas de sites web à la chaîne ici.",
                },
            },
            honesty: {
                title: { nl: "Eerlijke Communicatie", en: "Honest Communication", fr: "Communication Honnête" },
                description: {
            ...
            improvement: {
                title: { nl: "Continue Verbetering", en: "Continuous Improvement", fr: "Amélioration Continue" },
                description: {
                    ...
                    fr: "Nous restons à jour avec les tendances de design et les technologies web pour que votre site soit toujours moderne.",
                },
            },
            longTerm: {
                title: { nl: "Langetermijn Denken", en: "Long-Term Thinking", fr: "Pensée à Long Terme" },
                description: {
                    ...
                    fr: "Nous construisons des relations, pas seulement des sites web. Votre succès est notre succès.",
                },
            },
        },
        ...
        startConversation: { nl: "Start een Gesprek", en: "Start a Conversation", fr: "Démarrer une Conversation" },
    },
    ...
    contact: {
        ...
        subtitle: {
            ...
            fr: "Prêt à transformer votre présence en ligne ? Parlez-nous de votre projet et nous vous répondrons dans les 24 heures.",
        },
        form: {
            ...
            messagePlaceholder: {
                ...
                fr: "Que recherchez-vous ? Quel est votre calendrier ? Des exigences spécifiques ?",
            },
        ...
        info: {
            ...
            description: {
                ...
                fr: "Que vous ayez un projet spécifique en tête ou que vous souhaitiez simplement explorer les possibilités, nous sommes là pour vous aider. Aucune pression, juste une conversation amicale sur vos objectifs.",
            },
            ...
            step1: { nl: "We bekijken je bericht en projectdetails", en: "We review your message and project details", fr: "Nous examinons votre message et les détails du projet" },
