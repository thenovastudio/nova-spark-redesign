...
const steps = [
  ...
  },
  {
    ...
    number: "02",
    title: "Design",
    description: "Crafting beautiful, conversion-focused designs that align with your brand identity.",
  },
  {
    icon: Code2,
    number: "03",
    title: "Build",
    description: "Developing your website with clean code, optimized performance, and SEO best practices.",
  },
  {
    icon: Rocket,
    number: "04",
    title: "Launch",
    description: "Testing, refinement, and a smooth launch with ongoing support to ensure success.",
  },
];
