...
const projects = [
    ...
    },
    {
        ...
        description:
            "Users gain better awareness of their energy habits, allowing them to make smarter decisions with less effort and no unnecessary complexity.",
        image: "/powerplan.svg",
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
                    <div className="max-w-2xl">
                        ...
                        <p className="mt-4 text-lg text-muted-foreground">
                            Real projects with measurable results. See how we've helped
                            businesses grow.
                        </p>
                    </div>
