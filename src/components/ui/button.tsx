...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-bold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/85 shadow-lg hover:shadow-2xl active:scale-95",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-lg hover:shadow-xl active:scale-95",
        outline: "border-2 border-border bg-background hover:bg-primary/5 hover:border-primary/60 active:scale-95",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-md hover:shadow-lg active:scale-95",
        ghost: "hover:bg-secondary/10 hover:text-secondary-foreground active:scale-95",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-primary text-primary-foreground hover:bg-primary/85 shadow-xl hover:shadow-2xl text-base font-bold active:scale-95",
        "hero-outline": "border-2 border-foreground/40 bg-transparent text-foreground hover:bg-foreground/8 hover:border-foreground/60 text-base font-bold active:scale-95",
      },
      size: {
