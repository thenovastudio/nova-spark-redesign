...
const projects = [
  ...
  },
  {
    ...
    problem: "Personal finance apps are often cluttered and overwhelming, making it hard for users to track their spending habits.",
    solution: "A minimalist dashboard design with intuitive data visualization and smart categorization of expenses.",
    value: "Users can understand their finances at a glance, leading to better money management decisions.",
    image: "/placeholder.svg",
  },
  {
