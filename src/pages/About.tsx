...
const values = [
  {
    ...
    description: "We take on fewer projects to give each one the attention it deserves. No assembly-line websites here.",
  },
  {
    title: "Honest Communication",
    description: "We tell you what you need to hear, not what you want to hear. Transparency builds trust.",
  },
  {
    title: "Continuous Improvement",
    description: "We stay current with design trends and web technologies so your site is always modern.",
  },
  {
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="aspect-square bg-secondary rounded-2xl flex items-center justify-center">
              <span className="text-8xl font-bold text-foreground/10">N</span>
            </div>
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  Outdated designs, slow loading times, and zero focus on conversion 
                  are costing them customers every day.
                </p>
                <p>
                  We started this studio to change that. Our mission is to give 
                  Belgian businesses — freelancers, local shops, professional 
                  services — the same quality web presence that big companies enjoy, 
                  but at a price and pace that makes sense.
                </p>
                <p>
                  Every website we build is designed with one goal: to help your 
                  business grow. Beautiful design is important, but it's worthless 
                  if it doesn't convert visitors into customers.
                </p>
              </div>
